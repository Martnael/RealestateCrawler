...
public class Unit {
    ...
    public void setUnitStatusId(int unitStatusId) {
    ...
    public void setUnitProjectId(int unitProjectId) {
    ...
    public int getUnitUrlId() {
        return unitUrlId;
    }

    public void setUnitUrlId(int unitUrlId) {
        this.unitUrlId = unitUrlId;
    }
    ...
    public void setUnitRooms(int unitRooms) {
